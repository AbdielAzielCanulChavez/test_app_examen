...
import 'package:testapp/actividades/splashScreen.dart';
import 'package:testapp/model/persona_model.dart';
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  onPressed: (){
                    if(ap_paterno.text != "" && nombre.text != ""
                    && password.text != "" && telefono.text != ""
                    && correo.text != "" && sexo.text != ""){
